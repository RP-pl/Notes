...
public class DrawingLayout extends VBox {
    ...
    public DrawingLayout(){
        ...
        this.getStylesheets().add(getResource("/com/notes/styles/Drawing/NumberComponent.css"));
        this.getStylesheets().add(getResource("/com/notes/styles/Drawing/DrawComponentBar.css"));
        this.getStylesheets().add(getResource("/com/notes/styles/Drawing/DrawingLayout.css"));
        this.getStylesheets().add(getResource("/com/notes/styles/Drawing/DrawComponent.css"));
        this.getStylesheets().add(getResource("/com/notes/styles/Drawing/DrawCanvas.css"));
